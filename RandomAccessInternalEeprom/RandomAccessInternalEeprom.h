...
#ifndef __ARDUINO_IO_RANDOM_ACCESS_INTERNAL_EEPROM_H__
#define __ARDUINO_IO_RANDOM_ACCESS_INTERNAL_EEPROM_H__ 1
...
#endif /* __ARDUINO_IO_RANDOM_ACCESS_INTERNAL_EEPROM_H__ */
